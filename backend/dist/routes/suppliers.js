 ...
 * Get all suppliers
 */
router.get('/:companyId/suppliers', auth_1.isAuthenticated, async (req, res) => {
    try {
 ...
 * Create new supplier
 */
router.post('/:companyId/suppliers', auth_1.isAuthenticated, async (req, res) => {
    try {
        const { companyId } = req.params;
 ...
 * Update supplier
 */
router.put('/:companyId/suppliers/:supplierId', auth_1.isAuthenticated, async (req, res) => {
    try {
